...
export const menuItems: (MenuItemLink | MenuItemHeader)[] = [
	...
	},
	{
		...
		children: [
			...
			// International Soccer Zen GM mod (Epic 6): the same pages under their World names
			{
				type: "link",
				active: (pageID) => pageID === "standings",
				league: true,
	...
	},
	{
		...
		children: [
			...
			// International Soccer Zen GM mod (Epic 6): a World has transfers instead
			// of trades
			{
				type: "link",
				active: (pageID) => pageID === "transferMarket",
				league: true,
				commandPalette: true,
				world: true,
			...
			},
			{
				...
				league: true,
				commandPalette: true,
				// International Soccer Zen GM mod (Epic 6): a World has academies instead
				world: false,
				path: ["draft"],
				text: "Draft",
			},
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				league: true,
				commandPalette: true,
				// International Soccer Zen GM mod (Epic 6): these tools don't fit a
				// World's Countries and Divisions
				world: false,
