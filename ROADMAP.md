...
**Status: stages A (the AI transfer market), B (wage budgets and market wages), and C (the user in the market) done, and loans between AI clubs from stage D.** The user's side of loans is still to do.
...
- **Stage D — loans, the user's side:** the user borrowing players from AI clubs and lending theirs out, on the Transfer Market.
- **Loans need a roster decision before they matter:** in the World test's 3 auto-played seasons (24 clubs), AI clubs made no loans at all, against 29 transfers. With ZenGM's basketball roster limits of 13 to 15, a club needs 14 or more players to lend and 14 or fewer to borrow, and AI rosters are almost always at 15 while a window is open (promotions and free agency fill them). The rules work when rosters have room, which the World test sets up directly. Options: players on loan don't count toward the borrower's roster limit, AI clubs release a bench player to make room for a loan, or Worlds get bigger rosters.
